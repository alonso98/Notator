...
namespace UpdateNotator.Web
{
    public static class VueServer
    {
        ...
        public static void UseVueDevelopmentServer(this ISpaBuilder spa)
        {
            ...
            {
                var loggerFactory = spa.ApplicationBuilder.ApplicationServices.GetService(typeof(ILoggerFactory)); //GetService<ILoggerFactory>();
                var logger = (loggerFactory as ILoggerFactory).CreateLogger("Vue");
